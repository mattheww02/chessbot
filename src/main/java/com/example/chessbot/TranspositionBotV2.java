...
public class TranspositionBotV2 implements ChessPlayer {
    ...
    public TranspositionBotV2(int initialMaxDepth) {
        this(initialMaxDepth, initialMaxDepth * 2, 10000);
    }

    public TranspositionBotV2(int initialMaxDepth, int finalMaxDepth) {
        this(initialMaxDepth, finalMaxDepth, 10000);
    }

    public TranspositionBotV2(int initialMaxDepth, int finalMaxDepth, int cacheSize) {
    ...
    public short getMove(Position position){
        ...
        for (short move : legalMoves){
            ...
            if (transpositionTable.containsKey(hash)){
                eval = transpositionTable.get(hash);
            }
            else{
